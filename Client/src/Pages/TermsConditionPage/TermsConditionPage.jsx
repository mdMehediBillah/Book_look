    ...
    >
      <div className="container mx-auto  bg-gray-100 p-4">
        ...
        <div className="w-10/12 mx-auto">
          ...
          <div className="flex flex-col items-left ">
            <h6 className="pb-2 font-semibold ">§ 2 Conclusion of Contract</h6>
            <p className="text-sm pb-4">
              By installing and using the App, a contract is concluded between
              the User and the Provider. The User agrees to these T&C upon first
              use of the App.
            </p>
          </div>
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              The Provider provides the User with the App, which allows the User
              to borrow and donate physical books from bookshelves throughout
              the country. The locations of the books are displayed on a map.
              The User can also use their location to determine a route to the
              bookshelf. The User must register in the App with their data.
            </p>
          </div>
          <div className="flex flex-col items-left ">
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              ...
              books should be in good condition. The Provider reserves the right
              to collect and document data on donated books.
            </p>
          </div>
          <div className="flex flex-col items-left ">
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              Amendments to these T&C must be made in writing. If any provision
              of these T&C is invalid, the remaining provisions shall remain in
              full force and effect. The place of jurisdiction is [Berlin].
            </p>
          </div>
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              ...
              Provider grants the User a non-exclusive, worldwide, royalty-free
              license to use the App for personal, non-commercial purposes. The
              User is not permitted to copy, modify, distribute, or sell the App
              ...
              including but not limited to the code, design, and content of the
              App. The User is not permitted to copy, modify, distribute, or
              sell the App without the Provider's prior written consent.
            </p>
          </div>
          <div className="flex flex-col items-left ">
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              ...
              Provider with respect to the subject matter hereof and supersede
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              No waiver of any provision of these T&C shall be effective unless
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              ...
              person, upon the first business day following deposit in the mail,
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              ...
              T&C shall be brought before the exclusive jurisdiction of the
          ...
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              These T&C may be amended at any time by the Provider upon written
              notice to the User. Any such amendment shall be effective upon the
              date of such notice.
            </p>
          </div>
          <div className="flex flex-col items-left ">
            ...
            <p className="text-sm pb-4">
              These T&C are binding upon and inure to the benefit of the parties
              hereto and their respective successors and permitted assigns. No
              assignment of these T&C shall be effective without the prior
              written consent of the Provider. These T&C may be amended only by
              a writing signed by both parties. If any provision of these T&C is
              held to be invalid or unenforceable, such provision shall be
              struck from these T&C and the remaining provisions shall remain in
              full force and effect. These T&C constitute the entire agreement
